...
// Edit based on https://github.com/alt-research/mach-avs/blob/feat/m2/contracts/script/EigenLayerDeployer.s.sol
// Used for testing on testnets only
...
contract EigenLayerDeployer is Script {
    ...
    function run() external {
        ...
        console.log("!!!!!!!!!!!!!!!!!!!!!!!!");
        console.log(address(eigenLayerContracts.avsDirectoryImplementation));
        ...
        eigenLayerContracts.eigenLayerProxyAdmin.upgradeAndCall(
            ITransparentUpgradeableProxy(payable(address(eigenLayerContracts.avsDirectory))),
        ...
        // DelegationManager
        eigenLayerContracts.eigenLayerProxyAdmin.upgradeAndCall(
            ITransparentUpgradeableProxy(payable(address(eigenLayerContracts.delegationManager))),
        ...
        // StrategyManager
        eigenLayerContracts.eigenLayerProxyAdmin.upgradeAndCall(
            ITransparentUpgradeableProxy(payable(address(eigenLayerContracts.strategyManager))),
        ...
        // Slasher
        eigenLayerContracts.eigenLayerProxyAdmin.upgradeAndCall(
            ITransparentUpgradeableProxy(payable(address(eigenLayerContracts.slasher))),
        ...
        // EigenPodManager
        eigenLayerContracts.eigenLayerProxyAdmin.upgradeAndCall(
            ITransparentUpgradeableProxy(payable(address(eigenLayerContracts.eigenPodManager))),
        ...
        eigenLayerContracts.eigenLayerProxyAdmin.upgradeAndCall(
            ITransparentUpgradeableProxy(payable(address(eigenLayerContracts.delayedWithdrawalRouter))),
        ...
        string memory outputFilePath = string.concat(vm.projectRoot(), "/script/output/eigenlayer_deploy_output.json");
