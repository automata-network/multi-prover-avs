...
contract SGXVerifier {
    ...
    function register(bytes calldata report) public {
        (bool succ, bytes memory reportData) = dcapAttestation.verifyAttestation(report);
    ...
    function isProverRegistered(bytes32 pubkeyX, bytes32 pubkeyY) view public returns (bool) {
    ...
    function verifyAttestation(bytes32 pubkeyX, bytes32 pubkeyY, bytes calldata data) view public returns (bool) {
