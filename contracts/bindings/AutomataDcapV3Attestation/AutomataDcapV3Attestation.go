...
//
// Solidity: function verifyAttestation(bytes data) view returns(bool)
func (_AutomataDcapV3Attestation *AutomataDcapV3AttestationCaller) VerifyAttestation(opts *bind.CallOpts, data []byte) (bool, error) {
	var out []interface{}
...
//
// Solidity: function verifyAttestation(bytes data) view returns(bool)
func (_AutomataDcapV3Attestation *AutomataDcapV3AttestationSession) VerifyAttestation(data []byte) (bool, error) {
...
//
// Solidity: function verifyAttestation(bytes data) view returns(bool)
func (_AutomataDcapV3Attestation *AutomataDcapV3AttestationCallerSession) VerifyAttestation(data []byte) (bool, error) {
	return _AutomataDcapV3Attestation.Contract.VerifyAttestation(&_AutomataDcapV3Attestation.CallOpts, data)
}
